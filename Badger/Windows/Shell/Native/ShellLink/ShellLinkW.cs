...
namespace Badger.Windows.Shell.Native {
    public class ShellLinkW : IShellLink {
        public IShellLinkW Wrapped { get; private set; }
        
        public ShellLinkW(IShellLinkW Wrapped) {
        ...
        public void GetPath(StringBuilder pszFile, int cchMaxPath, ref _WIN32_FIND_DATA pfd, uint fFlags) {
            var Converted = pfd.To_WIN32_FIND_DATAW();
