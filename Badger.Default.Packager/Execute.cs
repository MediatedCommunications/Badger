...
namespace Badger.Default.Packager {
    public static class Execute {
        ...
        public static void Configuration(this PackagerConfiguration This) {
            ...
            if (This.Installer.Stub.Include()) {
                ...
                try {
                    ...
                    using (var AssemblyDef = Mono.Cecil.AssemblyDefinition.ReadAssembly(InstallerOutput, new Mono.Cecil.ReaderParameters {
                        ...
                        Resources.AddFromFile(Badger.Default.Installer.PackageContentResource.ResourceName, Archive_Output);

                        if (This.Installer.SplashScreen.Include()) {
                            Logger.Info("Adding Splash Screen Content...");
                            Resources.AddFromFile(Badger.Default.Installer.SpashScreenResource.ResourceName, This.Installer.SplashScreen.Source);
                        }



                        Logger.Info("Adding Installer Playbook...");
                        var InstallerConfig = new Badger.Default.Installer.Configuration() {
                        ...
                        Resources.AddFromObject(Badger.Default.Installer.ConfigurationResource.ResourceName, InstallerConfig);
